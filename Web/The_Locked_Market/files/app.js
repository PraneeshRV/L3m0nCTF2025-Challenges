...
// --- VULNERABILITY 2: RACE CONDITION (MITIGATED?) ---
...
app.post('/cart/apply_coupon', async (req, res) => {
    ...
    try {
        ...
        // 4. ACT
        // Note: We "should" check coupons_applied again here if we wanted to be safe, 
        // but the lock is supposed to handle it. 
        // The vulnerability is that the user can unlock it externally.
